        ...
        <div className="flex min-h-screen flex-col overflow-x-hidden bg-[#FCFCFC] font-sans text-slate-950 selection:bg-amber-500 selection:text-white dark:bg-neutral-950 dark:text-white">
            ...
            {minimal ? (
                <header className="sticky top-0 z-50 flex h-20 items-center justify-between border-b border-slate-100 bg-white/90 px-6 backdrop-blur-lg sm:px-12 dark:border-neutral-900 dark:bg-neutral-950/90">
                    ...
                    <Link
                        href="/"
                        className="text-xs font-bold text-slate-500 transition hover:text-amber-500 dark:text-neutral-400 dark:hover:text-amber-400"
                    >
                        Back
                    </Link>
                </header>
            ...
            {minimal ? (
                <footer className="dark:text-neutral-550 border-t border-slate-100 bg-white py-6 text-center text-xs text-slate-400 dark:border-neutral-900 dark:bg-neutral-950">
                    © 2026 Nutrivision Indonesia. Seluruh hak cipta dilindungi.
                </footer>
            ) : (
                        ...
                        <div className="mb-16 grid gap-12 md:grid-cols-4">
                            <div className="col-span-1 space-y-6 md:col-span-2">
                                ...
                                <p className="max-w-sm text-xs leading-relaxed text-slate-400">
                                    Nutrivision adalah asisten kesehatan masa
                                    depan yang menggabungkan kecerdasan buatan
                                    dengan ilmu gizi untuk membantu jutaan orang
                                    hidup lebih sehat melalui kesadaran makanan.
                                </p>
                                <div className="flex gap-4">
                                    <a
                                        href="#"
                                        className="flex h-10 w-10 items-center justify-center rounded-full bg-white/5 transition-colors hover:bg-amber-500"
                                    >
                            ...
                            <div>
                                <h5 className="mb-6 text-[10px] font-bold tracking-widest text-amber-500 uppercase">
                                    Navigasi
                                </h5>
